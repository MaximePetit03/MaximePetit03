...
🚀 Featured Projects
  ...
  - [Script Fighter](https://afabien9.itch.io/script-fighter) —— Video game created in two days during a Game Jamin Javascript
  - [Naval battle](https://github.com/MaximePetit03/BatailleProjet) —— Naval Battle in PHP 8 using MySQL without Javascript
  - [JS Arena](https://github.com/MaximePetit03/FarmingGame-Java) —— A JavaScript-based battle royale game where you can play online with people on the same server address.

🛠️ Tech Stack

HTML5/CSS3, PHP 8, SQL, MySql, C, JavaScript, Java 21, TypeScript, Python, Bash
